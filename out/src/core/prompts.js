...
exports.testsPrompt = testsPrompt;
exports.readmePrompt = readmePrompt;
exports.coveragePrompt = coveragePrompt;
exports.stylePrompt = stylePrompt;
const FENCE = '```';
function fileBlock(file) {
    return `File: ${file.path} (language: ${file.language})\n${FENCE}${file.language}\n${file.content}\n${FENCE}`;
}
function testsPrompt(file) {
    return [
